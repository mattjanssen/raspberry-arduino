...
#define NUM_LEDS 3                                          // Number of LED's
...
//  LEDS.addLeds<LED_TYPE, LED_DT, LED_CK, COLOR_ORDER>(leds, NUM_LEDS);   // For APA102 or WS2801
  ...
  FastLED.setMaxPowerInVoltsAndMilliamps(5, 20000);              // FastLED 2.1 Power management set at 5V, 500mA
...
// thishue = beatsin8(50,0,255);                              // This can change speeds on the fly. You can also add these to each other.
  ...
  fill_rainbow(leds, NUM_LEDS, CRGB(0,0,255));            // Use FastLED's fill_rainbow routine.
